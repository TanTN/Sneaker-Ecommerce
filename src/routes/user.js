...
routes.get('/cartUser/:uid',verifyToken,ctrl.getCartUser)
routes.get('/userCurrent',[verifyToken],ctrl.getUserCurrent)
routes.get('/getUser/:uid',[verifyToken, isAdmin],ctrl.getUser)
...
routes.get('/getProductToCart/:cid',verifyToken,ctrl.getProductToCart)
